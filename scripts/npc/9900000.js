    ...
    if (status == 1) {
        ...
        if (cm.getMeso() > price) {
            if (selection == 0) {
                ...
                var selectedHair = selection == 1 ? hair : fhair;
                for (var i = 0; i < selectedHair.length; i++) {
                    pushIfItemExists(hairnew, selectedHair[i]);
                }
                ...
                var selectedFace = selection == 3 ? face : fface;
                for (var j = 0; j < selectedFace.length; j++) {
                    pushIfItemExists(facenew, selectedFace[j]);
                }
