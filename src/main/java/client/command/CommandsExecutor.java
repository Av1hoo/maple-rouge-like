...
import client.command.commands.gm0.HomeCommand;
...
import client.command.commands.gm0.QuestCommand;
import client.command.commands.gm0.QuestCommand2;
...
import client.command.commands.gm3.GiveItemCommand;
...
public class CommandsExecutor {
    ...
    private void registerLv0Commands() {
        ...
        addCommand("quest", QuestCommand.class);
        addCommand("quest2", QuestCommand2.class);
    ...
    private void registerLv3Commands() {
        ...
        addCommand("giveitem", 3, GiveItemCommand.class);
